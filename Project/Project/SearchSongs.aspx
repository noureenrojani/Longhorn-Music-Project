<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="SearchSongs.aspx.vb" Inherits="Project.SearchSongs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="searchcriteria">
    <asp:Label ID="searchby" runat="server" Text="Search for Songs by:"></asp:Label>
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" CellSpacing="20" CellPadding="0">
            <asp:ListItem>Song Title:</asp:ListItem>
    ...
    <div id="searchbutton">
        ...
        <asp:GridView ID="gvSongResults" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
