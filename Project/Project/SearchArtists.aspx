<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="SearchArtists.aspx.vb" Inherits="Project.SearchAlbums" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="searchcriteria">
    <asp:Label ID="searchby" runat="server" Text="Search for Artist by:"></asp:Label>
        ...
        <br />
        <br />
        <asp:CheckBoxList ID="cbxList" runat="server" RepeatColumns="2" >
        </asp:CheckBoxList>
        <br />
        <br />
        </div>
